...
#ifndef EVRMORE_VERSION_H
#define EVRMORE_VERSION_H
...
//! getassetdata returns asstnotfound, and assetdata doesn't have blockhash in the data
static const int ASSETDATA_VERSION_UPDATED = 70020;

//! In this version the mining algo was changed to X16RV2
...
//! In this version the mining algo was changed to KAWPOW
...
static const int MIN_PEER_PROTO_VERSION = P2SH_ASSETS_VERSION;


#endif // EVRMORE_VERSION_H
