...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "issue", 6, "has_ipfs" },
    { "issue", 9, "toll_amount" },
    { "issue", 11, "toll_amount_mutability" },
    { "issue", 12, "toll_address_mutability" },
    { "issue", 13, "remintable" },
    { "issuerestrictedasset", 1, "qty" },
    { "issuerestrictedasset", 5, "units" },
    { "issuerestrictedasset", 6, "reissuable" },
    { "issuerestrictedasset", 7, "has_ipfs" },
    { "issuerestrictedasset", 10, "toll_amount" },
    { "issuerestrictedasset", 12, "toll_amount_mutability" },
    { "issuerestrictedasset", 13, "toll_address_mutability" },
    { "issuerestrictedasset", 14, "remintable" },
    ...
    { "reissuerestrictedasset", 10, "change_toll_amount" },
    { "reissuerestrictedasset", 11, "toll_amount" },
    { "reissuerestrictedasset", 13, "toll_amount_mutability" },
    { "reissuerestrictedasset", 14, "toll_address_mutability" },
    { "issueunique", 1, "asset_tags"},
    { "issueunique", 2, "ipfs_hashes"},
    { "issueunique", 5, "permanent_ipfs_hashes"},
    { "issueunique", 7, "toll_amount"},
    { "issueunique", 8, "toll_amount_mutability" },
    { "issueunique", 9, "toll_address_mutability" },
    { "transfer", 1, "qty"},
    ...
    { "reissue", 5, "new_unit"},
    { "reissue", 8, "toll_changed"},
    { "reissue", 9, "new_toll_amount"},
    { "reissue", 11, "toll_amount_mutability"},
    { "reissue", 12, "toll_address_mutability"},
    { "remint", 1, "qty"},
    { "remint", 4, "remintable"},
    { "updatemetadata", 5, "change_toll_amount"},
    { "updatemetadata", 6, "toll_amount"},
    { "updatemetadata", 7, "toll_amount_mutability"},
    { "updatemetadata", 8, "toll_address_mutability"},
    { "getcalculatedtoll", 1, "amount"},
    { "getcalculatedtoll", 2, "change_amount"},
    { "getcalculatedtoll", 3, "overwrite_toll_fee"},
