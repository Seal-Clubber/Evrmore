...
#ifndef EVRMORE_AMOUNT_H
#define EVRMORE_AMOUNT_H
 ...
 *
 * Note that this constant is *not* the total money supply, which in Evrmore
 * currently happens to be less than 21,000,000,000 EVR for various reasons, but
