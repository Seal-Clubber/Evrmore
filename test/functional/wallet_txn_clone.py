...
class TxnMallTest(EvrmoreTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 69450 EVR:
        ...
        # 40 EVR serialized is 00286bee00000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Check node0's total balance; should be same as before the clone, + 100 EVR for 2 matured,
